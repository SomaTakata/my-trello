              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <button
                    ...
                    className="w-full border border-gray-300 rounded-md outline-none p-5 focus-visible;rinf
                  g-2 focus-visible:ring-blue-500 focus:visible:ring-offset-2"
                  >
                  ...
                  {image && (
                    <Image
                      ...
                      width={200}
                      height={200}
                      className="w-full h-44 objective-cover mt-2 filter hover:grayscale taransion-all
                    duration-150 cursor-allowed"
